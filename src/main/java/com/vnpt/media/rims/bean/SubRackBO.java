...
public class SubRackBO {
    ...
    public String getRackFrameNo() {
        return rackFrameNo;
    }

    public void setRackFrameNo(String rackFrameNo) {
        this.rackFrameNo = rackFrameNo;
    }

    public String getBomRackType() {
        return bomRackType;
    }

    public void setBomRackType(String bomRackType) {
        this.bomRackType = bomRackType;
    }
    ...
    public long getEqRackId() {
        return eqRackId;
    }

    public void setEqRackId(long eqRackId) {
        this.eqRackId = eqRackId;
    }
