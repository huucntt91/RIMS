 ...
 * @author VNP
 */
public class OmcCell3gInfoBO extends NodeBO implements Serializable {
...
//    info
    ...
    public OmcCell3gInfoBO() {
    }

    public OmcCell3gInfoBO(NodeBO temp) {
    ...
    public OmcCell3gInfoBO(Long nodeId) {
        this.nodeId = nodeId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OmcCell3gInfoBO)) {
            return false;
        }
        OmcCell3gInfoBO other = (OmcCell3gInfoBO) object;
    ...
    public String toString() {
        return "com.vnpt.media.rims.bean.OmcCell3gInfoBO[ nodeId=" + nodeId + " ]";
    }
