 ...
 * @author VNP
 */
public class UpdateDuAnNguonVTTExcel {
    ...
    @Column(name = "ngayNghiemThuACCU", index = "12")
    private String ngayNghiemThuACCU;
    @Column(name = "ghiChuVTT", index = "13")
    private String ghiChuVTT;
    ...
    public String getNgayNghiemThuACCU() {
        return ngayNghiemThuACCU;
    }

    public void setNgayNghiemThuACCU(String ngayNghiemThuACCU) {
        this.ngayNghiemThuACCU = ngayNghiemThuACCU;
    }

    public String getGhiChuVTT() {
        return ghiChuVTT;
    }

    public void setGhiChuVTT(String ghiChuVTT) {
        this.ghiChuVTT = ghiChuVTT;
    }
