...
public class AutoMailJob_bk02112018 implements Job {

    private static Logger logger = LogManager.getLogger(AutoMailJob_bk02112018.class);
    ...
    private void writeDuplicateLacCi(String fileName, File fileTemplate, String folderTemp, List<?> temp) {
        try {
            ...
            Row row = null;
            int rowIndex = 1;
            if (temp !=null && fileName.contains("2G")) {
            ...
            } else if (temp !=null && fileName.contains("3G")) {
    ...
    private void writeInventoryRims(String fileName, File fileTemplate, String folderTemp, List<?> temp) {
        try {
            ...
            } else if (temp !=null && fileName.contains("4G")) {
