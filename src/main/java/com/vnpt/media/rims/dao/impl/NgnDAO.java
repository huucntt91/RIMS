...
public class NgnDAO extends GenericDAO implements INgn {

    private static Logger logger = LogManager.getLogger(NgnDAO.class);
    ...
    public List<NgnInfoBO> findAllNgnInfo(int startRow, int endRow, String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_NGN_INFO.fc_find_all(?,?,?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int getTotalNgnInfo(String name, String id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_NGN_INFO.fc_find_total(?,?) }";
//       
    ...
    @Override
    public int addNgnInfo(NgnInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_NGN_INFO.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    @Override
    public int updateNgnInfo(NgnInfoBO item,Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_NGN_INFO.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    public int deleteNgnInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_NGN_INFO.fc_delete(?) }";
//       
