...
public class StpDAO extends GenericDAO implements IStp {

    private static Logger logger = LogManager.getLogger(StpDAO.class);
    ...
    public List<StpInfoBO> findAllStpInfo(int startRow, int endRow, String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_STP_INFO.fc_find_all(?,?,?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int getTotalStpInfo(String name, String id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_STP_INFO.fc_find_total(?,?) }";
//       
    ...
    @Override
    public int addStpInfo(StpInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_STP_INFO.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    @Override
    public int updateStpInfo(StpInfoBO item,Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_STP_INFO.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    public int deleteStpInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_STP_INFO.fc_delete(?) }";
//       
