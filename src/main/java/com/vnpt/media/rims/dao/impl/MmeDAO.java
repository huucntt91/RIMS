...
public class MmeDAO extends GenericDAO implements IMme {

    private static Logger logger = LogManager.getLogger(MmeDAO.class);
    ...
    public List<MmeInfoBO> findAllMmeInfo(String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call pkg_mme_info.fc_find_all(?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addMmeInfo(MmeInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call pkg_mme_info.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int updateMmeInfo(MmeInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_mme_info.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    public int deleteMmeInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_mme_info.fc_delete(?) }";
//       
