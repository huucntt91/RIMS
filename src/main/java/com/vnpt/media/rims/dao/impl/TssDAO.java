...
public class TssDAO extends GenericDAO implements ITss {

    private static Logger logger = LogManager.getLogger(TssDAO.class);
    ...
    public List<TssInfoBO> findAllTssInfo(int startRow, int endRow, String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_TSS_INFO.fc_find_all(?,?,?,?) }";
//       
...
item.setOpc(rs.getString("opc"));
    ...
    @Override
    public int getTotalTssInfo(String name, String id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_TSS_INFO.fc_find_total(?,?) }";
//       
    ...
    @Override
    public int addTssInfo(TssInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_TSS_INFO.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    @Override
    public int updateTssInfo(TssInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_TSS_INFO.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    public int deleteTssInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_TSS_INFO.fc_delete(?) }";
//       
    ...
    public List<NodeBO> getNode(String listNeTypeId) throws ServiceException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_NODE.fn_find_all_by_neType(?) }";
//       


            List<Object> vars = new Vector<Object>();
            vars.add(listNeTypeId);
