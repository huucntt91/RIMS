...
public class RcDAO extends GenericDAO implements IRc {

    private static Logger logger = LogManager.getLogger(RcDAO.class);
...
//                    item.setCardVersion(rs.getString("card_version"));
    ...
    @Override
    public int addRcInfo(RcInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
//            vars.add(item.getCardSL());
    ...
    @Override
    public int updateRcInfo(RcInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
