...
public class SgsnDAO extends GenericDAO implements ISgsn {

    private static Logger logger = LogManager.getLogger(SgsnDAO.class);
    ...
    public List<SgsnInfoBO> findAllSgsnInfo(String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call pkg_sgsn_info.fc_find_all(?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addSgsnInfo(SgsnInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call pkg_sgsn_info.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int updateSgsnInfo(SgsnInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_sgsn_info.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    public int deleteSgsnInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_sgsn_info.fc_delete(?) }";
//       
