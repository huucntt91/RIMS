...
public class UssdDAO extends GenericDAO implements IUssd {

    private static Logger logger = LogManager.getLogger(UssdDAO.class);
    ...
    public List<UssdInfoBO> findAllUssdInfo(String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_USSD_INFO.fc_find_all(?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addUssdInfo(UssdInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_USSD_INFO.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int updateUssdInfo(UssdInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_USSD_INFO.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    public int deleteUssdInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_USSD_INFO.fc_delete(?) }";
//       
