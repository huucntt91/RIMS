...
public class GgsnDAO extends GenericDAO implements IGgsn {

    private static Logger logger = LogManager.getLogger(GgsnDAO.class);

    @Override
    public List<GgsnInfoBO> findAllGgsnInfo(String name, String id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_ggsn_info.fc_find_all(?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addGgsnInfo(GgsnInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call pkg_ggsn_info.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int updateGgsnInfo(GgsnInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_ggsn_info.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int deleteGgsnInfo(Long id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call pkg_ggsn_info.fc_delete(?) }";
//       
