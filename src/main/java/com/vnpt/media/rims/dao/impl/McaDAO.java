...
public class McaDAO extends GenericDAO implements IMca {

    private static Logger logger = LogManager.getLogger(McaDAO.class);

    @Override
    public List<McaInfoBO> findAllMcaInfo(String name, String id) throws DAOException {
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addMcaInfo(McaInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
//       
    ...
    @Override
    public int updateMcaInfo(McaInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
//       
    ...
    @Override
    public int deleteMcaInfo(Long id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
