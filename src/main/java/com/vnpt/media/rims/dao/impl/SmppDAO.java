...
public class SmppDAO extends GenericDAO implements ISmpp {

    private static Logger logger = LogManager.getLogger(SmppDAO.class);
    ...
    public List<SmppInfoBO> findAllSmppInfo(String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_SMPP.fc_find_all(?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int addSmppInfo(SmppInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_SMPP.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    @Override
    public int updateSmppInfo(SmppInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_SMPP.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
//       
    ...
    public int deleteSmppInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_SMPP.fc_delete(?) }";
//       
