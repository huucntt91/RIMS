...
public class MgwDAO extends GenericDAO implements IMgw {

    private static Logger logger = LogManager.getLogger(MgwDAO.class);
    ...
    public List<MgwInfoBO> findAllMgwInfo(int startRow, int endRow, String name, String id) throws DAOException {
        ...
        try {
            ...
            String querySql = "{? = call PKG_MGW_INFO.fc_find_all(?,?,?,?) }";
//       
...
//                    item.setLoaiTramId(rs.getLong("LOAI_TRAM_ID"));
    ...
    @Override
    public int getTotalMgwInfo(String name, String id) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_MGW_INFO.fc_find_total(?,?) }";
//       
    ...
    @Override
    public int addMgwInfo(MgwInfoBO item, Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
...
// prs_hoan_canh_ra_doi VARCHAR2, prs_ngay_dang_ky DATE, prs_type VARCHAR2
            String querySql = "{? = call PKG_MGW_INFO.fc_insert(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    @Override
    public int updateMgwInfo(MgwInfoBO item,Long userInsert) throws DAOException {
        Connection conn = null;
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_MGW_INFO.fc_update(?,?,?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?) }";
//       
    ...
    public int deleteMgwInfo(Long id) throws DAOException {
        ...
        try {
            conn = this.getConnection();
            String querySql = "{? = call PKG_MGW_INFO.fc_delete(?) }";
//       
