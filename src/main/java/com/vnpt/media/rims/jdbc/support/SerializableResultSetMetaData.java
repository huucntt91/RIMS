...
public class SerializableResultSetMetaData implements ResultSetMetaData,Serializable {
	...
	private static final long serialVersionUID = -6682454433627402692L;
	...
	public int getColumnIndexByName(String columnName) throws SQLException {
		Integer i = _columnNameIndexRef.get(columnName.toLowerCase());
		if (i == null)
	...
	private HashMap<String, Integer> _columnNameIndexRef = new HashMap<String, Integer>();
