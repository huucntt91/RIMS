...
@Controller
@RequestMapping(value = "/loaidat")
public class DMLoaiDatController {

    private static final Logger logger = LogManager.getLogger(DMLoaiDatController.class);
    private static final String LIST = "categories/loaidat/list";
    private static final String FORM = "categories/loaidat/form";
    ...
    public String init(ModelMap mm, HttpServletRequest request) {
        ArrayList<DMLoaiDatBO> list = LoaiDatFacade.fc_find_all("");
        mm.put("list", list);
        return LIST;
    }
    ...
    public String preAdd(ModelMap mm) throws Exception {
        DMLoaiDatBO model = new DMLoaiDatBO();
    ...
    public String view(@PathVariable(value = "id") String id,
        ...
        try {
            if (StringUtils.hasText(id)) {
                ArrayList<DMLoaiDatBO> list = LoaiDatFacade.fc_find_all(id);
    ...
    public String add(ModelMap mm, @Valid @ModelAttribute(value = "model") DMLoaiDatBO model,
        ...
        try {
            if (bindingResult.hasErrors()) {
                ...
                mm.addAttribute("model", model);
                return "redirect:/loaidat/preAdd";
            }
            if (LoaiDatFacade.fn_modify("add", model.loai_dat_id, model.ten_loai_dat) > 0) {
                attr.addFlashAttribute("info", new Message(Message.TYPE_SUCCESS, Message.HEAD_SUCCESS, Message.MESSAGE_UPDATE_SUCCESS));
                return "redirect:/loaidat/init";
            } else {
                String msg = messageSource.getMessage("admin.common.error", null, locale);
                attr.addFlashAttribute("info", new Message(Message.TYPE_DANGER, Message.HEAD_DANGER, msg));
                return "redirect:/loaidat/preAdd";
    ...
    public String update(ModelMap mm, @Valid @ModelAttribute(value = "model") DMLoaiDatBO model,
            BindingResult bindingResult, RedirectAttributes attr) throws Exception {
        Locale locale = LocaleContextHolder.getLocale();
        try {
            if (bindingResult.hasErrors()) {
                ...
                mm.addAttribute("model", model);
                return "redirect:/loaidat/view/" + model.loai_dat_id;
            }
            if (LoaiDatFacade.fn_modify("edit", model.loai_dat_id, model.ten_loai_dat) > 0) {
                attr.addFlashAttribute("info", new Message(Message.TYPE_SUCCESS, Message.HEAD_SUCCESS, Message.MESSAGE_UPDATE_SUCCESS));
                return "redirect:/loaidat/init";
            } else {
                String msg = messageSource.getMessage("admin.common.error", null, locale);
    ...
    public String delete(ModelMap mm, @PathVariable(value = "Id") String Id,
        ...
        try {
            if (LoaiDatFacade.fn_modify("del", Id, "") > -1) {
