...
import com.vnpt.media.rims.facade.VlanFacade;
...
public class VlanController {
    ...
    private static final String REDIRECT = "redirect:/vlan/init";
    private static Logger logger = LogManager.getLogger(VlanController.class);
    private static final String LIST = "broadband/vlan/list";
    ...
    public String init(
        ...
        int totalRows = VlanFacade.countSearch(tnodes);
        ...
        if (pageInt < 1) {
            pageInt = 1;
            return ("redirect:/vlan/init?page=" + pageInt);
        ...
        List<VlanBO> list = VlanFacade.findAll(String.valueOf(startRow), String.valueOf(endRow), tnodes);
