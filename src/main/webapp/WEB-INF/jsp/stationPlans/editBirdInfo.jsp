                    ...
                    <div class="box">
                        ...
                        <form:form method="post" action="update" commandName="tramDA">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                ...
                                <%--<div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"BIRD_INFO")}'> style="display: none" </c:if>>--%>
                                <div class="panel panel-primary" >
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Thông tin quản lý triển khai dự án</h3>
                                    </div>
                                    <%--<div class="panel-body" <c:if test='${!fn:contains(classAtrrEdit,"BIRD_INFO")}'> disableGroup="disable" </c:if>>--%> 
                                    <div class="panel-body"> 
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <form:input
                                                    type="text" class="form-control" id="exampleInputEmail1" path="maSoHopDong"
                                        ...
                                        <!--dmTrangThaiCsht trangThaiCsht-->
                                        
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label class=" input-group-addon" style="font-weight: bold; min-width:150px;"  for="exampleInputEmail1">Trạng thái CSHT</label>    
                                                <select name="trangThaiCsht" id="trangThaiCsht" class="form-control" > 
                                                    <option value="">--- Chọn---</option>
                                                    <c:forEach var="dmTrangThaiCsht" items="${dmTrangThaiCshtList}">
                                                        <option  
                                                            value="${dmTrangThaiCsht.trang_thai_csht_id}"  <c:choose>
                                                                <c:when test="${dmTrangThaiCsht.trang_thai_csht_id == tramDA.trangThaiCsht}">
                                                                    selected    
                                                                </c:when>    
                                                            </c:choose>

                                                            >${dmTrangThaiCsht.ten_trang_thai_csht}</option>
                                                    </c:forEach>
                                                </select>   
                                            </div>
                                        </div>
