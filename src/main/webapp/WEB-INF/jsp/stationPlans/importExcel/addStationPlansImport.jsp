    ...
    <body>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Upload file excel trạm dự án</h3>
                        </div>
                        <form:form method="post" action="${pageContext.request.contextPath}/stationPlansExcelImport/checkFile" commandName="groupContactForm"
        ...
        <script>
            function btDownloadTemplate() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/MaudangkymamDA.xlsx";
            }
