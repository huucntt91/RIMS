...
<section class="content-header">
    <h1>
        Quản lý Danh mục Firewall
    </h1>
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/firewallDir/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm Firewall</span> 
        </button>
    </ol>
</section>
<section class="content">   
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách Firewall</h3>
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>${temp.fireWallName}</td>
                                        <td>${temp.note}</td>
                                        
                                        <td>
                                            <a href="<%=request.getContextPath()%>/firewallDir/view/${temp.id}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/firewallDir/delete/${temp.id}"
