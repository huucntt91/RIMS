        ...
        <div class="col-xs-12">
            ...
            <div class="box" style="min-height: 400px">
                ...
                <form:form method="GET" id="frm_search">
                    <div class="formSearch" style="width:700px;">
                        <div class="col-xs-5">
                            <input name="tnode1" placeholder="Node 1"   id="tnode1" class="form-control" value="${tnode1}" />
                        </div>
                        
                        <div class="col-xs-5">
                              <input name="tnode2" placeholder="Node 2"  id="tnode2" class="form-control" value="${tnode2}" />
                        </div>
                        <div class="col-xs-2">
...
<script>
    ...
    // create an array with nodes
        <c:if test="${nodeList != null}">
            ...
            nodesData = getPotionNodeData(${tnode1}, ${tnode2});
