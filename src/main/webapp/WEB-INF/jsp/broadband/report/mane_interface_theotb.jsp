        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tổng hợp interface theo thiết bị (MANE)</h3>
                </div>
                <form method="get">
                    <div class="box-body"> 
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/interface/interfaceTbMane?tinhTpId=' + $('#tinhTpId').val()"> 
