        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Thống kê hiệu suất sử dụng cổng DSLAM theo tỉnh</h3>
                </div>
                <form method="get">
                    <div class="box-body"> 
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/access/reportPortDSLAMTinh?tinhTpId='+ $('#tinhTpId').val()"> <spring:message code="admin.common.export.excel" /></button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
                                    <th>Tên tỉnh</th>
                                    <th>Số DSLAM đã kết nối</th>
                                    <th>Số cổng DSLAM đã kết nối</th>
                                    <th>Số cổng DSLAM sử dụng</th>
                            ...
                            <tbody>                                       
                                <c:forEach var="it" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>${it.tong_tb}</td>
                                        <td>${it.portDslamConnect}</td>
                                        <td>${it.portDslamUsed}</td>
