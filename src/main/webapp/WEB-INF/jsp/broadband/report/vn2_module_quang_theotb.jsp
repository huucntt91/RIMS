        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tổng hợp module quang theo thiết bị (VN2)</h3>
                </div>
                <form method="get">
                    <div class="box-body"> 
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/reportBB/reportModuleQuangTheoTbVn2?tinhTpId=' + $('#tinhTpId').val()"> 
