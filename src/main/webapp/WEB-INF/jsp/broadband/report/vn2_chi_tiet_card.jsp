        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Báo cáo chi tiết card theo Tỉnh/TP (VN2)</h3>
                </div>
                <form method="get">
                    <div class="box-body"> 
...
<!--                            <div class="col-md-4">
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/reportBB/reportChiTietCardVn2?typeId=' + $('#typeId').val()
