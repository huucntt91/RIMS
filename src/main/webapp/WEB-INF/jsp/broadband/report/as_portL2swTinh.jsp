        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Thống kê hiệu suất sử dụng cổng L2sw theo tỉnh</h3>
                </div>
                <form method="get">
                    <div class="box-body"> 
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/access/reportPortL2SWTinh?tinhTpId='+ $('#tinhTpId').val()"> <spring:message code="admin.common.export.excel" /></button>
                    </div>
                </form>
            </div>
        </div>
