...
<section class="content">            
            ...
            <div class="box">
                ...
                <form method="GET" id="frm_search">
                    ...
                    <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportEvc?tnode_id='+ $('#tnodes').val()">Xuất excel</button>
                    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách kênh ảo EVC</h3>
...
<!--                    <button type="button" id="export" class="btn btn-primary" 
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th rowspan="2">STT</th>
                                <th rowspan="2">Vc-Index</th>
                                <th rowspan="2">Vc-Id</th>
                                <th colspan="3">Đầu gần</th>
                                <th colspan="3">Đầu xa</th>
                                <th rowspan="2">Hoạt động</th>
                            </tr>
                            <tr>
                                <th>Trạng thái</th>
                                <th>Interface</th>
                                <th>Thiết bị đầu nối trực tiếp</th>
                                <th>Trạng thái</th>
                                <th>Địa chỉ</th>
                                <th>Mô tả</th>
                            </tr>
