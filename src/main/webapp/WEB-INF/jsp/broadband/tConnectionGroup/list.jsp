...
<section class="content-header">
    <h1>
        Quản lý Connection Group
    </h1>
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/tConnectionGroup/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm Connection Group</span> 
        </button>
    </ol>
</section>
<section class="content">   
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách Connection Group</h3>
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/tConnectionGroup/view/${temp.tConnectionGroupId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/tConnectionGroup/delete/${temp.tConnectionGroupId}"
