...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/tConnection/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm Connection</span> 
        </button>
    </ol>
</section>
<section class="content">   
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input name="tConnectionName" value="${tConnectionName}"
                                           type="text" class="form-control" id="exampleInputEmail1"
                                           placeholder="Tên Connection">
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách Connection</h3>
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>${temp.tConnectionGroupName}</td>
                                        <td>${temp.note}</td>

                                        <td>
                                            <a href="<%=request.getContextPath()%>/tConnection/view/${temp.tConnectionId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/tConnection/delete/${temp.tConnectionId}"
