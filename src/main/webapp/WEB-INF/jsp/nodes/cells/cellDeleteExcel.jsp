...
<html>
    ...
    <body>
        <div class="content-header">
            <h1>Đăng ký hủy cell 2G/cell 3G/cell 4G
            ...
            <ol class="breadcrumb">                
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="${pageContext.request.contextPath}/cellExcelImport/files/Template_DELETE_NODE">Biểu mẫu hủy cell 2G/3G/4G</a></li>
                    </ul>
                </div>
            </ol>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <form:form method="POST" action="${pageContext.request.contextPath}/cellsExcel/delete" commandName="cellNewExcelBO"
