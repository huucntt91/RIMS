    ...
    <form:form method="post" action="${pageContext.request.contextPath}/cells/updateCell2g" commandName="cellNewForm">
       ...
       -->
        ...
        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"RF_INFO")}'>    style="display: none" </c:if>>
                ...
                <div class="form-group">
                    <div class="input-group">  
                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">tenNgQLy</label>
                        <form:input  class="form-control" 
                ...
                <div class="form-group">
                    <div class="input-group">  
                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">SDTQLy</label>
                        <form:input  class="form-control" 
