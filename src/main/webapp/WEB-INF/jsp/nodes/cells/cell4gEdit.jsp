        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Cập nhật thông tin cell 4G</h3>
                </div>
                <div class="box-body" id="mydiv" >                                    
                    <form:form method="post" action="${pageContext.request.contextPath}/cells/updateCell4g" commandName="cellNewForm">
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"AREA")}'>    style="display: none" </c:if>>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <label class=" input-group-addon" for="exampleInputEmail1">Mã EnodeB</label>
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"BIRTH_INFO")}'>    style="display: none" </c:if>>
                                ...
                                <div class="panel-body"  <c:if test='${!fn:contains(classAtrrEdit,"BIRTH_INFO")}'> disableGroup="disable" </c:if>>        
                                    <div class="form-group">
                                        ...
                                        <form:input required="true" type="text" class="form-control" path="tenCell" placeholder="Tên cho quản lý" 
                                ...
                                <div class="form-group">
                                    <div class="input-group">                                                                                    
                                        ...
                                        <form:input required="true"  type="text" class="form-control" placeholder="Hoàn cảnh ra đời " 
                                                    path="hoanCanhRaDoi" />
                                    </div>                                                                                                
                                </div>
                                <div class="form-group" class="form-control">                                              
                                    <div class="input-group">                                                                                    
                                        ...
                                        <form:input required="true"  class="form-control date_form" id="ngayHoatDong" 
                                                    path="ngayHoatDong" />                    
                                    </div>                                                                                                
                                    <script>
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"OMC_INFO")}'>   style="display: none" </c:if>>
                                ...
                                <div class="panel-body"  <c:if test='${!fn:contains(classAtrrEdit,"OMC_INFO")}'> disableGroup="disable" </c:if>>        
                                    <div class="form-group">
                                        ...
                                        <form:input required="true"  class="form-control" placeholder="Tên trên hệ thống" name="temTrenHeThong" 
                                                    path="tenTrenHeThong"/>
                                    </div>                                                                                                
                                </div>
                                <!--                                <div class="form-group">
                                                                    <div class="input-group">                                
                                                                        ...
                                                                        <input  required="true" class="form-control" placeholder="LAC" name="lac" type="number"
                                                                                     path="lac"/>
                                                                    </div>
                                                                </div>-->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-group">                                
                                        ...
                                        <select name="bangTanId" id="bangTanId" class="form-control" required="true" >
                                            ...
                                            <c:forEach var="it" items="${bangTanList4G}">
                ...
                <div class="form-group">
                    <div class="input-group">                                
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"RF_INFO")}'>    style="display: none" </c:if>>
                                ...
                                <div class="form-group">
                                    <div class="input-group">  
                                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">electricalTilt</label>
                                        <form:input  class="form-control"  type="number"
                                ...
                                <div class="form-group">
                                    <div class="input-group">  
                                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">antennaModel</label>
                                        <form:input  class="form-control" 
                                ...
                                <div class="form-group">
                                    <div class="input-group">  
                                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">antennaPattern</label>
                                        <form:input  class="form-control" 
                                ...
                                <div class="form-group">
                                    <div class="input-group">  
                                        ...
                                        <form:input  class="form-control" 
                                                     path="tac" name="cellNewForm.tac"/>
                                    </div>                                                                                                
                                </div>
                                <div class="form-group">
                                    <div class="input-group">  
                                        <label class=" input-group-addon" style="font-weight: bold; min-width:150px;" for="exampleInputEmail1">LCRID</label>
                                        <form:input  class="form-control" 
                                                     path="lcrid" name="cellNewForm.lcrid"/>
                                    </div>                                                                                                
                                </div>
                                <div class="form-group">
                                    <div class="input-group">  
