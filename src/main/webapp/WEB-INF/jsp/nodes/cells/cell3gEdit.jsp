        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Cập nhật thông tin cell 3G</h3>
                </div>
                <div class="box-body" id="mydiv" >                                    
                    <form:form method="post" action="${pageContext.request.contextPath}/cells/updateCell3g" commandName="cellNewForm">
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"AREA")}'>    style="display: none" </c:if>>
                                ...
                                <div class="form-group">
                                    <div class="input-group">  
                                        ...
                                        <input required="true" type="text" value="${cellNewForm.codeBuilding}"  class="form-control" id="codeBuilding" placeholder="Mã CSHT" disabled  /> 
                        ...
                        <div class="panel panel-primary" <c:if test='${!fn:contains(classAtrrView,"BIRTH_INFO")}'>    style="display: none" </c:if>>
                                ...
                                <div class="form-group">
                                    <div class="input-group">                                                                                    
                                        <label required="true" class=" input-group-addon" style="min-width:150px;">Hoàn cảnh ra đời</label>
                                ...
                                <div class="form-group" class="form-control">                                              
                                    <div class="input-group">                                                                                    
                                        <label required="true" class=" input-group-addon" style="min-width:150px;">Ngày hoạt động</label>
                                ...
                                <div class="form-group">
                                    <div class="input-group">                                
                                        ...
                                        <select name="bangTanId" id="bangTanId" class="form-control" required="true" >
                                            ...
                                            <c:forEach var="it" items="${bangTanList3G}">
