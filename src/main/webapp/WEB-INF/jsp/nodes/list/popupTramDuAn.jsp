                            ...
                            <div class="box-body">
                                <div class="form-group" style="padding: 0 15px">
                                    <input name="code" value="${code}"
                                           ...
                                           placeholder="Nhập mã trạm hoặc tên trạm dự án">
                                </div>
                            </div>
                            <!-- /.box-body -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Chọn 1 trong các trạm dự án bên dưới</h3>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>                                       
                                    <c:forEach var="item" items="${list}" varStatus="status">                                        
                                        <tr>
                                            <td> 
                                                <input type="hidden" class="tram_id" value="${item.id}"/>
                                                <input type="hidden" class="tram_code" value="${item.code}"/>
