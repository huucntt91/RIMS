...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/ggsn/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm GGSN</span> 
        </button>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách GGSN</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div >
                        <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportGgsn'">Export excel</button>
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/ggsn/view/${temp.nodeId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/ggsn/delete/${temp.nodeId}"
                                            ...
                                            <a style="cursor: pointer" href="<%=request.getContextPath()%>/history/ps?type=GGSN&code=${temp.nodeId}"
                                               title="Lịch sử GGSN" >
