        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Quản lý PGW</h3>
                </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class="input-group">  
                                ...
                                <input  type="text" class="form-control" name="tenHeThong" placeholder="Tên trên hệ thống" value="${item.tenHeThong}" />
                            </div>   
                        </div>
                        <div class="form-group">
                            <div class="input-group">  
                                <label class=" input-group-addon" style="min-width:150px;" for="exampleInputEmail1">Attack File Config</label>                             
                                <form:input type="file" path="fileAttackConfig" class="form-control" value="${item.fileConfig}"/>
                            </div>   
                            <c:if test='${item.fileConfig != null && item.fileConfig != "" }'>
                                <a href="${item.fileConfig}">Download file Config</a>
                            </c:if>
                        </div>            
                    </div>
                    <!-- /.box-body -->
