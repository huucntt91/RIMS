...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/mme/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm MME</span> 
        </button>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách MME</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div >
                        <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportMme'">Export excel</button>
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/mme/view/${temp.nodeId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/mme/delete/${temp.nodeId}"
                                            ...
                                            <button type="button"  class="btn btn-link" style="border: 0px; padding:0px;"  data-toggle="modal" data-target="#myModal" onclick="nelink('${temp.code}',${temp.nodeId},${temp.neTypeId})"id="btn_bts"  >
                                             ...
                                             <a style="cursor: pointer" href="<%=request.getContextPath()%>/history/ps?type=MME&code=${temp.nodeId}"
                                               title="Lịch sử MME" >
