...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/dns/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm DNS</span> 
        </button>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách DNS</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div >
                        <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportDns'">Export excel</button>
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/dns/view/${temp.nodeId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/dns/delete/${temp.nodeId}"
                                            ...
                                            <a style="cursor: pointer" href="<%=request.getContextPath()%>/history/ps?type=DNS&code=${temp.nodeId}"
                                               title="Lịch sử DNS" >
