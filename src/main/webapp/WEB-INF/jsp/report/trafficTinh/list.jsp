...
<!--                                        <p>Date: ${hiddenTime}</p>  -->
                    ...
                    <div class="box-footer" align="center">
                        ...
                        <button type="button" class="btn btn-primary"onclick="location.href = '<%=request.getContextPath()%>/reportTrafficTinh/reportTrafficTinh?techType='+ $('#techType').val()+ '&timeType=' + $('#timeType').val()
