...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/hss/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm HSS</span> 
        </button>
    </ol>
</section>
<section class="content">   
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách HSS</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div id="tablePagingId">
                        <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportHss?name='
                            ...
                            <tbody>                                       
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/hss/view/${temp.nodeId}"
                                               title="Sửa">
                                                <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                            </a>  
                                            <a href="<%=request.getContextPath()%>/hss/delete/${temp.nodeId}"
                                            ...
                                            <a style="cursor: pointer" href="<%=request.getContextPath()%>/history/cs?type=HSS&code=${temp.nodeId}"
                                               title="Lịch sử HSS" >
