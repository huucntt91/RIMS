...
<section class="content">   
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách HLR</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div id="tablePagingId">
                        <button type="button" id="export" class="btn btn-primary" 
                            onclick="location.href = '<%=request.getContextPath()%>/jasper/exportHlr?name='
                                ...
                                <c:forEach var="temp" items="${list}" varStatus="status">                                        
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a style="cursor: pointer" href="<%=request.getContextPath()%>/history/cs?type=HLR&code=${temp.nodeId}"
                                               title="Lịch sử HLR" >
