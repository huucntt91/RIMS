    ...
    <body>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Upload file excel dự án nguồn</h3>
                        </div>
                        <form:form method="post" action="${pageContext.request.contextPath}/duAnNguon/importFileVTT" commandName="groupContactForm"
        ...
        <script>
            function btDownloadTemplate() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/MauDangKyNguonDuAnVTT.xlsx";
            }
