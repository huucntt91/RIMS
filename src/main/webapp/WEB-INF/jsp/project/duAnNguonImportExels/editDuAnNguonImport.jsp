    ...
    <body>
        ...
        <section class="content">  
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Cập nhật thông tin dự án nguồn của PTM</h3>
                            </div>
                            <form:form method="post" action="${pageContext.request.contextPath}/duAnNguon/upDateFilePTM" commandName="groupContactForm"
            ...
            <%--<c:if test='${fn:contains(classAtrrEdit,"DEVICE_INFRA")}'>--%>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Cập nhật thông tin dự án nguồn của VTT</h3>
                            </div>
                            <form:form method="post" action="${pageContext.request.contextPath}/duAnNguon/upDateFileVTT" commandName="groupContactForm"
                                       enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Cập nhật thông tin dự án nguồn của QLDAHT1</h3>
                        </div>
                        <form:form method="post" action="${pageContext.request.contextPath}/duAnNguon/upDateFileQLDAHT1" commandName="groupContactForm"
                                   enctype="multipart/form-data">
                            ...
                            <div class="box-body" >
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">                                    
                                        <button type="button" onclick="btDownloadTemplateQLDAHT1();" class="btn btn-facebook">Download biểu mẫu</button>
                                    </div>
                                </div>
                            </div>
                            </br>
        ...
        <script>
            function btDownloadTemplate() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/MauCapNhatNguonDuAnVTT.xlsx";
            }
            
            
            function btDownloadTemplatePTM() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/MauCapNhatNguonDuAnPTM.xlsx";
            }
            
            function btDownloadTemplateQLDAHT1() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/MauCapNhatNguonDuAnQLDAHT1.xlsx";
            }
