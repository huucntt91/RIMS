...
<html>
    ...
    <body>  
        <section class="content-header">
            <h1>Thêm câu lệnh sql cho báo cáo</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">                        
            ...
            <div style="margin-top: 24px;">                                                        
                ...
                <div class="box box-primary" style="width: 50%; float: left;">
                    <div class="box-body">
                        <h4> <b>Danh sách tên câu lệnh sql:</b></h4>
                        <hr/>
                        ...
                        <table id="table-source" class="display">
                            ...
                            <tbody>
                                <c:forEach var="groupBO1" items="${list_sql_no_report}" varStatus="statusgroupBO">                                        
                                    <tr>
                                        <td>${groupBO1.idSql}</td>
                                        <td>${groupBO1.sqlName}</td>                                    
                                    </tr> 
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="box-body">
                        ...
                        <table id="table-dest" class="display">
                            <thead>
                                <tr>
                                    <th>
                                        ...
                                        <input type="hidden" id="action" value="${pageContext.request.contextPath}/autoEmail/updateSqlToReport"/>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="groupBO" items="${list_sql_to_report}" varStatus="status">                                        
                                    <tr>
                                        <td>${groupBO.idSql}</td>
                                        <td>${groupBO.sqlName}</td>                                        
                                    </tr>    
                                </c:forEach>
                            </tbody>
                        </table>
