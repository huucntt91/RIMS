        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Quản lý Loại AnTen</h3>
                </div>
                <form:form method="post" action="update" commandName="model">

                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên Loại AnTen</label>                                    
                            <form:hidden path="id" title="${model.id}"></form:hidden>   
                            <input required type="text" class="form-control" name="name" placeholder="Tên Loại AnTen" value="${model.name}" />
                        </div>   
                    </div>    
