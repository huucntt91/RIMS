                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Quản lý danh mục Điều Hòa</h3>
                        </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <form:hidden path="Id" title="${model.id}"></form:hidden>   
                                        <input required type="text" class="form-control" name="ten" placeholder="Tên chủng loại điều hòa" value="${model.ten}" />
                                </div>   
                            </div>    
