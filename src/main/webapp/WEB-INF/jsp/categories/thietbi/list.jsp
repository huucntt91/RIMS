...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <button class="btn btn-info btn-sm"  onclick="location.href = '<%=request.getContextPath()%>/thietbi/preAdd'" >
            <span><i class="fa fa-fw fa-plus"></i>Thêm Thiết Bị</span> 
        </button>
                        ...
                        <tbody>                                       
                            <c:forEach var="item" items="${list}" varStatus="status">                                        
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/thietbi/view/${item.thietBiId}"
                                           title="Sửa">
                                            <img src="<%=request.getContextPath()%>/image/icon/edit_icon.png">
                                        </a>  
                                        <a href="<%=request.getContextPath()%>/thietbi/delete/${item.thietBiId}"
