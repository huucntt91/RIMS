...
<%@include file="../../include/header.jsp"%>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Upload file excel khai báo CSHT</h3>
                        </div>
                        <form:form method="post" action="${pageContext.request.contextPath}/building/khaibaoExcel" commandName="groupContactForm"
                            ...
                            <div class="box-footer">
                                <button type="submit" id="upload" class="btn btn-primary">Khai báo dữ liệu</button>
                            </div>
                        </form:form>
                    </div>
                </div>
        ...
        <script>
            function btDownloadTemplate() {
                window.location.href = "${pageContext.request.contextPath}/resources/excel/Template_Reg_CSHT.xlsx";
            }
