    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <form:form method="GET" action="${pageContext.request.contextPath}/dataAuditSummary/detail/cell2g_info/-1">
                    <div class="box-body">
...
<script lang="text/javascript">
    ...
    {
        $("#myModal iframe").prop({'src': '${pageContext.request.contextPath}/nodes/popup?neTypeId=5'});
        $('#auditId').val(id);
