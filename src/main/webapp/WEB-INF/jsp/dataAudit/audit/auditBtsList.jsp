    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <form:form method="GET" action="${pageContext.request.contextPath}/dataAuditSummary/detail/bts_info/-1">
                    <div class="box-body">
                            ...
                            <tbody >                                       
                                <c:forEach var="userBO" items="${list_audit_detail}" varStatus="status">                                        
                                    <tr 
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/dataAuditSummary/update/bts_info/${userBO.type}/${userBO.id}/1"
                                               title="Cập nhật trạng thái" 
                                               onclick="return confirm('Đã cập nhật thông tin bản ghi ?')">
...
<script lang="text/javascript">
    ...
    {
        $("#myModal iframe").prop({'src': '${pageContext.request.contextPath}/nodes/popup?neTypeId=2'});
        $('#auditId').val(id);
