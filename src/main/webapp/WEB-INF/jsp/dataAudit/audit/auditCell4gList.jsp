    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <form:form method="GET" action="${pageContext.request.contextPath}/dataAuditSummary/detail/cell4g_info/-1">
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="8" style=" border-left-width: 2px;border-left-color: black;">RIMS</th>
...
<script>
    ...
    {
        $("#myModal iframe").prop({'src': '${pageContext.request.contextPath}/nodes/popup?neTypeId=7'});
        $('#auditId').val(id);
