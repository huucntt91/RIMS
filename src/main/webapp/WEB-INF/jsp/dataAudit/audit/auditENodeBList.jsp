    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <form:form method="GET" action="${pageContext.request.contextPath}/dataAuditSummary/detail/enodeb_info/-1">
                    <div class="box-body">
                            ...
                            <tbody>                                       
                                <c:forEach var="userBO" items="${list_audit_detail}" varStatus="status">                                        
                                    <tr  
                                        ...
                                        <!--<td>${userBO.rEnodebCode}</td>-->
                                        <td>${userBO.rEnodebName}</td>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/dataAuditSummary/update/enodeb_info/${userBO.type}/${userBO.id}/1"
...
<script>
    ...
    {
        $("#myModal iframe").prop({'src': '${pageContext.request.contextPath}/nodes/popup?neTypeId=8'});
        $('#auditId').val(id);
    ...
    function regOff(nodeId, idAudit) {
        ...
        $("#myModalLabel").html('Đăng ký off enodeb');
        $(".modal-body #status").val(status);
        $(".modal-body #nodeId").val(nodeId);
        $(".modal-body #idAudit").val(idAudit);
        $(".modal-body #name").val('enodeb_info');
